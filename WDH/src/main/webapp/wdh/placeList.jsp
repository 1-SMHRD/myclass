    ...
    <%@page import="java.util.List" %>
            ...
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                    ...
                    <head>
                        ...
                        <!-- Bootstrap -->
                        <link type="text/css" rel="stylesheet" href="${cpath}/wdh/css/bootstrap.min.css" />


                        <!-- Slick -->
                        <link type="text/css" rel="stylesheet" href="${cpath}/wdh/css/slick.css" />
                        <link type="text/css" rel="stylesheet" href="${cpath}/wdh/css/slick-theme.css" />

                        <!-- nouislider -->
                        <link type="text/css" rel="stylesheet" href="${cpath}/wdh/css/nouislider.min.css" />
		...
		<![endif]-->
					...
					<table>
                            ...
                            <c:forEach var="vo" begin="0" end="11" step="3" items="${place_list}" varStatus="i">
                            
								<td>
                                <div class="product" style="margin-right: 20px;width: 150px; height: 180px">
...
<!-- 2qjsWO fhdn -->
					...
					<table>
                            ...
                            <c:forEach var="vo" begin="1" end="12" step="3" items="${place_list}" varStatus="i">
...
<!--  -->
					...
					<table>
                            ...
                            <c:forEach var="vo" begin="2" end="12" step="3" items="${place_list}" varStatus="i">
