	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
		<div class="item active">
			<div class="img-write"><h1>한번도 경험해보지 못한 최고의 여행을 만드세요!</h1></div>
			<img src="./img/bg002.png" style="width: 100%; height: auto;"/>
			
		</div>
  
		<div class="item">
			<div class="img-write"><h1>여기서뭐행과 함께라면 가능합니다!</h1></div>
		  <img src="./img/bg003.png" style="width: 100%; height: auto;"/>
			
		</div>
	  
		<div class="item">
			<div class="img-write"><h1>결코 후회하지 않을겁니다!</h1></div>
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												<h3 class="product-name"><a href="#">여수 오동도</a></h3>
