...
public class MemberVO {
	 ...
	 * @param mem_pohne
	 * @param mem_service
	 * @param mem_pcy_agmt_yn
	 * @param mem_loc_base_svc_agmt_yn
	 * @param mem_staty_pref_1
	 * @param mem_staty_pref_2
	 * @param mem_staty_pref_3
	 * @param mem_place_pref_1
	 * @param mem_place_pref_2
	 * @param mem_joindate
	 * @param mem_type
	 */
	public MemberVO(String mem_Id, String mem_Pw, String mem_gender, String mem_nick, String mem_birthdate,
			String mem_pohne, String mem_service, String mem_pcy_agmt_yn, String mem_loc_base_svc_agmt_yn,
	...
	public String getMem_pohone() {
		return mem_pohone;
	}
	public void setMem_pohone(String mem_pohne) {
		this.mem_pohone = mem_pohne;
	}
	...
	public String toString() {
		return "MemberVO [mem_Id=" + mem_Id + ", mem_Pw=" + mem_Pw + ", mem_gender=" + mem_gender + ", mem_nick=" + mem_nick
				+ ", mem_birthdate=" + mem_birthdate + ", mem_pohne=" + mem_pohone + ", mem_service=" + mem_service
				+ ", mem_pcy_agmt_yn=" + mem_pcy_agmt_yn + ", mem_loc_base_svc_agmt_yn=" + mem_loc_base_svc_agmt_yn
				+ ", mem_staty_pref_1=" + mem_staty_pref_1 + ", mem_staty_pref_2=" + mem_staty_pref_2
				+ ", mem_staty_pref_3=" + mem_staty_pref_3 + ", mem_place_pref_1=" + mem_place_pref_1
